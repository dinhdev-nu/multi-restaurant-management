          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-[10px] font-medium text-gray-600 dark:text-muted-foreground">Giá TB</p>
            ...
            <div className="hidden sm:block w-px h-8 bg-gray-200 dark:bg-border" />
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-[10px] font-medium text-gray-600 dark:text-muted-foreground">Tồn kho</p>
                <p className="text-sm font-bold text-gray-900 dark:text-foreground truncate">
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-[10px] font-medium text-gray-600 dark:text-muted-foreground">Trạng thái</p>
