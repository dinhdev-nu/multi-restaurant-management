...
const quarterlyForecast: QuarterlyData[] = [
    { quarter: "Quý 1", actual: 35250000000, forecast: 35000000000, target: 38000000000, orderCount: 2850, avgOrderValue: 12368421 },
    { quarter: "Quý 2", actual: null, forecast: 42000000000, target: 45000000000, orderCount: 3200, avgOrderValue: 13125000 },
    { quarter: "Quý 3", actual: null, forecast: 48000000000, target: 50000000000, orderCount: 3600, avgOrderValue: 13333333 },
    { quarter: "Quý 4", actual: null, forecast: 55000000000, target: 58000000000, orderCount: 4000, avgOrderValue: 13750000 },
];
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={forecastData}>
                                ...
                                <Tooltip
                                    ...
                                    formatter={(value) => [`${(Number(value) / 1000000000).toFixed(1)} tỷ`, ""]}
                                />
                                <Area
                                    type="monotone"
                                    dataKey="target"
                                ...
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        <div
                                            ...
                                            style={{ backgroundColor: scenarioColorMap[scenario.color] }}
                                        />
                                        <div>
